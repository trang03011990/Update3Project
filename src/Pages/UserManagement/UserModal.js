                        ...
                        <form onSubmit={formik.handleSubmit} role="form">
                            <div className="form-group">
                                <div className="input-group">
                                    ...
                                    <input value={formik.values.taiKhoan} name="taiKhoan" id="tknv" className="form-control input-sm" placeholder="Tài khoản" onChange={formik.handleChange} onBlur={formik.handleBlur} />
                                </div>
                                {formik.touched.taiKhoan && formik.errors.taiKhoan && <div className="text-danger text-left">{formik.errors.taiKhoan}</div>}
                            </div>
                            <div className="form-group">
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                ...
                                {formik.touched.hoTen && formik.errors.hoTen &&<div className="text-danger text-left">{formik.errors.hoTen}</div>}
                            </div>
                            <div className="form-group">
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                ...
                                {formik.touched.email && formik.errors.email &&<div className="text-danger text-left">{formik.errors.email}</div>}
                            </div>
                            <div className="form-group">
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                ...
                                {formik.touched.matKhau && formik.errors.matKhau &&<div className="text-danger text-left">{formik.errors.matKhau}</div>}
                            </div>
                            <div className="form-group">
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                ...
                                {formik.touched.soDt && formik.errors.soDt &&<div className="text-danger text-left">{formik.errors.soDt}</div>}
                            </div>
                            <div className="form-group">
                                <div className="input-group">
                                    <div className="input-group-prepend">
                                ...
                                {formik.touched.maLoaiNguoiDung && formik.errors.maLoaiNguoiDung &&<div className="text-danger text-left">{formik.errors.maLoaiNguoiDung}</div>}
                            </div>
